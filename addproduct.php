            ...
            <div class="greyarea">
                ...
                <form id="form1" autocomplete="off">
                    <div class="formitem">
                        ...
                        <input type="text" class="forminput" id="proddesc" required>
                        <label type="text" class="formlabel"> Product MRP </label>
                        <input type="text" class="forminput" id="prodprice" required>
                        <label type="text" class="formlabel"> Manufacture Location </label>
                        <input type="text" class="forminput" id="location" required>
